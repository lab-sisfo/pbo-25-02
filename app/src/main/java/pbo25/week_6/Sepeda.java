...
public class Sepeda extends Kendaraan implements IBergerak, IServisable {
    ...
    public Sepeda(String id, String merek, String model, int tahunProduksi, String jenisSepeda) {
